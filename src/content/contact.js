...
export const contactLinks = [
  {
    id: 'email',
    label: 'Email Me',
    href: 'mailto:dorin1979@gmail.com',
    supportingText: 'dorin1979@gmail.com',
    primary: true,
  },
  {
    id: 'linkedin',
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/pablo-dorin',
    external: true,
  },
  {
    id: 'github',
    label: 'GitHub',
    href: 'https://github.com/pablodorin',
    external: true,
  },
  {
    id: 'cv',
    label: 'Download CV',
    href: '/cv/Pablo_Dorin_CV_24_JUL_2026.pdf',
